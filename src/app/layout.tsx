...
export const metadata: Metadata = {
  title: "F1 Elite - Next Generation Formula 1 Racing Vehicles",
  description: "Discover championship-winning Formula 1 cars engineered for ultimate performance. Experience cutting-edge hybrid technology, aerodynamic mastery, and precision engineering.",
  keywords: "Formula 1, F1 cars, racing vehicles, hybrid engines, motorsport, performance",
  metadataBase: new URL("https://f1elite.com"),
  alternates: {
    canonical: "https://f1elite.com"
  },
  openGraph: {
    title: "F1 Elite - Next Generation Formula 1 Racing",
    description: "Explore the pinnacle of motorsport engineering with our F1 vehicle collection.",
    url: "https://f1elite.com",
    siteName: "F1 Elite",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34yEatLQt6B9A82mZgfqKsKaLO9/uploaded-1765904905930-k56xu8of.jpg",
      alt: "Formula 1 Elite Race Car"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "F1 Elite - Championship Racing Vehicles",
    description: "Experience the future of Formula 1 with cutting-edge engineering and performance.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34yEatLQt6B9A82mZgfqKsKaLO9/uploaded-1765904905930-k56xu8of.jpg"]
  },
  robots: {
    index: true,
    follow: true
